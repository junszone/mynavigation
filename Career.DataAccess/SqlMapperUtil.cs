...
namespace Career.DataAccess
{
    public static class SqlMapperUtil
    {
        ...
        private static string connectionString = ConnectionManager.ConnectionString; //@"server=(local);database=CV;uid=sa;pwd=sa";
        /// <summary>
        ...
        public static SqlConnection GetOpenConnection(string name = null)
        {
            ...
            string conStr = name == null ? connectionString : ConfigurationManager.ConnectionStrings[name].ConnectionString;
        ...
        //{
        //    using (SqlConnection cnn = GetOpenConnection(connectionString))
        //    {
